...
if (isset($_POST['add_user'])){
	...
	if (strlen($username) < 4 || strlen($username) > 100) {
		...
		if ($row >= 1) {
			...
			$sql2 = "INSERT INTO `user`(`username`, `user_email`, `user_password`, `user_role`) VALUES ('$username','$email','$pass','$role')";
	...
	<div class="row">
		<div class="col-md-5 m-auto bg-info p-4">
			...
			<form action="" method="POST">
				...
				<div class="mb-3">
					<input type="text" name="username" placeholder="Username" class="form-control" required value="">
				</div>
				<div class="mb-3">
