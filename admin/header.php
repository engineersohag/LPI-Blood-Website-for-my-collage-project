...
//    header("location:http://localhost/LPI_Blood_Bank/login.php");
// }
?>
...
<html lang="en">
   <head>
      ...
      <title>LPI Blood Admin - Dashboard</title>
      ...
      <div id="wrapper">
         ...
         <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
               ...
               <div class="sidebar-brand-text mx-3">LPI Blood</div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item">
               <a class="nav-link collapsed" href="index.php"> <span>Users</span> </a>
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider">
            <!-- Nav Item - Tables -->
            ...
            <li class="nav-item">
               <a class="nav-link collapsed" href="donors.php"> <span>Donars</span> </a>
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider">
            <!-- Nav Item - Tables -->
            <li class="nav-item">
               <a class="nav-link collapsed" href="blog.php"> <span>Blogs</span> </a>
            </li>
